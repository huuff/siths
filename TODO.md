...
* I finally saw the light! A `RedisCommandReceiver` shouldn't have so many weird implementations, only the most generic ones, then, a `SithsClient` provides all the overloads to make it easily wieldable
